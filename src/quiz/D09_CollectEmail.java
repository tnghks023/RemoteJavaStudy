...
public class D09_CollectEmail {

	/*
		다음 문자열에서 올바른 형식의 이메일만 적절한 컬렉션에 저장해보세요.
		(올바른 이메일이 총 몇 개 인지 세어보세요)
		
		중복되는 이메일이 있다면 무엇인지 찾기
	 */
	
	
	public static String email = "조선일보	가정/육아	박은주	zeeny@chosun.com\r\n"
	...
	public static void main(String[] args) {
		...
		while (m1.find()) {
			String str = email.substring(m1.start(), m1.end());
			if(list.contains(str)) {
				System.out.println(str);
			} else {
				list.add(email.substring(m1.start(), m1.end()));			
			}
